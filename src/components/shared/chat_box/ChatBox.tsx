...
import MyChat from "../my_chat/MyChat";
import OtherChat from "../other_chat/OtherChat";
...
const ChatBox = () => {
  return (
    <div>
      <div
        className="w-full flex flex-col h-screen justify-between"
        style={{
      ...
      >
        ...
        <div className="w-full pl-3 pr-1 py-1 rounded-3xl border border-gray-200 items-center gap-2 inline-flex justify-between">
          <div className="flex items-center gap-2">
            ...
            <FaRegCircleUser className="text-primary" />
            <input
